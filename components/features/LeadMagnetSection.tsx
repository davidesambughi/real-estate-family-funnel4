...
export async function LeadMagnetSection({
    locale,
    compact = false,
}: {
    locale: string;
    ...
    /* ── COMPACT mode: benefits + form card (used inline in page grids) */
    if (compact) {
        return (
            <div id="lead-magnet" className="space-y-8">

                {/* Benefits — invite the user to fill the form */}
                ...
                {/* Trust strip */}
                <div className="flex items-center justify-center gap-2 text-body-sm text-ink-muted flex-wrap">
    ...
    /* ── FULL mode: original standalone section layout */
    return (
